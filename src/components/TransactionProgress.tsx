    ...
    if (!isSendComplete && tx && tx.block && currentBlock) {
      ...
      return (
        <div className={classes.root}>
          ...
          <Typography variant="body2" className={classes.message}>
            {!isFinalized
              ? "You may now leave. If the transaction is not finalized, you will be contacted to pay again."
              : ""}
          </Typography>
        </div>
      );
    ...
    if (
      ...
      return (
        <div className={classes.root}>
          ...
          <Typography variant="body2" className={classes.message}>
            {blockDiff < expectedBlocks
              ? "You may not leave. If the transaction is not confirmed, you will be contacted to pay again."
              : ""}
          </Typography>
        </div>
      );
